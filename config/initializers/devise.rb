...
Devise.setup do |config|
  ...
  config.mailer_sender = 'pushsomething@chrismar035.com'
  ...
  # :database      = Support basic auth with authentication key + password
  ...
  # config.pepper = "REALLY LONG RANDOM STRING"
  ...
  # :time  = Re-enables login after a certain time (see :unlock_in below)
  ...
  # if you are using only default views. config.scoped_views = false
